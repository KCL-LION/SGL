...
# Setup GPIO
GPIO.setmode(GPIO.BCM)  # Use physical pin numbering, gpio drives me insane
GPIO.setwarnings(False)
 
# Motor GPIO Pins
LEFT_MOTOR_FORWARD = 12 #pwn pins
...
LEFT_PWM_FORWARD.start(25)
LEFT_PWM_BACKWARD.start(25)
RIGHT_PWM_FORWARD.start(25)
RIGHT_PWM_BACKWARD.start(25)
